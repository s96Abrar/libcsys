/*
libcsys is a library for DashBoard app

libcsys is free software; you can redistribute it and/or
...
QString UDisks2Block::toStringToSeperate(int i) {
    ...
    case 1:
        ...
        break;
    case 2:
        return FormatUtil::formatBytes(size);// Function from utilities.cpp
        break;
    case 3:
        return dev;
        break;
